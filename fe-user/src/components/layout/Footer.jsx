...
const Footer = () => {
  const footerLinks = {
    shop: [
      ...
      { name: 'Giày nam', href: '/products?gender=male' },
      { name: 'Giày nữ', href: '/products?gender=female' },
      { name: 'Khuyến mãi', href: '/products?sale=true' },
      { name: 'Hàng mới', href: '/products?sort=newest' },
    ],
    support: [
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <Link to="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">ShoeStore</span>
            </Link>
            <p className="text-gray-400 mb-4 max-w-md">
              Cửa hàng giày dép trực tuyến hàng đầu Việt Nam. Cam kết sản phẩm chính hãng,
              giá cả cạnh tranh và dịch vụ khách hàng tận tâm.
            </p>
